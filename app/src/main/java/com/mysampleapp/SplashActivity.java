...
public class SplashActivity extends Activity {
    ...
    protected void goMain() {
        ...
        goAfterSplashTimeout(new Intent(this,MainActivity.class ));//CameraActivity.class));
    }
    ...
    protected void goSignIn() {
        ...
        goAfterSplashTimeout(new Intent(this, SignInActivity.class));// CameraActivity.class));
    }
}
